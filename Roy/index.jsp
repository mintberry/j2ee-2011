...
<div id="container">
  ...
  <div id="mainContent">
    <blockquote>
      <blockquote><h1><strong><em>教务管理系统</em></strong></h1>
      </blockquote>
    </blockquote>
    <p>用户：
	        ...
	        <blockquote>
	          <blockquote>
	            <blockquote>
	              <blockquote>
	                <p>
	                  <input type="submit" name="Rigeiter" id="Rigeiter" value="注册" />	
                    </p>
	                <p>
	                  <input type="submit" name="Logging" id="Logging" value="登录" />
	                  <br class="clearfloat" />
                </p>
	              </blockquote>
	            </blockquote>
        ...
        <blockquote>
          <blockquote>
            <blockquote>
              <blockquote>
                <blockquote>
                  <p><img src="../Documents/J2EEWEBSITE/Image/Login.png" width="79" height="44" class="fltlft" /><br class="clearfloat" />
                  </p>
                </blockquote>
              </blockquote>
            </blockquote>
