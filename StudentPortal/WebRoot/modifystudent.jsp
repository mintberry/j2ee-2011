								...
								<div align="center">
									<form name="mailform"
										...
										<div id="row-email" class="row clearfix">
											...
											<div class="clearfix">
												...
												<span id="error1" style="display: none"
													style="font-size:10px"><font color=red>密码不符合要求</font>
												</span>
											</div>

											<div class="row-c bd">
												<input id="acc-email" type="password" class="text"
													name="email1" maxlength="200" />
											</div>
										...
										<div id="row-blog" class="row clearfix">
											...
											<div class="row-c bd">
												<input id="acc-blog" type="password" class="text"
													maxlength="500" name="email2" />
											</div>
										...
										<img alt="提交" src="imgs/login.png" class="submitbtn"
											...
											onclick="validateForm(document.mailform)" width="128"
											height="35" />
									</form>
								</div>
										...
										<table>
											<tbody style="color: #ffffff">
												...
												<tr>
													<td>
														当前邮箱地址：
														<div id="oldmail"><%=si.getEmail()%></div>
													</td>
												</tr>
											</tbody>
										</table>
